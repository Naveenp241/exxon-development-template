...
const MobilCustomHome: Template<TemplateRenderProps> = ({
  ...
  const formattedAccordionItems = (c_customAccordion as RawAccordionData[]).map(
    (region) => ({
      id: region.id,
      title: region.title,
    ...
    <div className="mobil-homepage">
      ...
      <div className="px-12 mb-16">
        <HeadingElement
          ...
          className={c_headingElement.className}
        />

        <Accordion
          items={formattedAccordionItems}
          accordionInactiveIcon="faAngleDown"
          accordionActiveIcon="faAngleUp"
        />
      </div>
